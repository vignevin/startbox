...
La fonction plot_xpbar2 permet de réaliser un graphique classique, dit "en batons".

```{r}
plot_xpbar2(df_complet,xcol="xp_trt_name",ycol="value",show_errorbar = F, 
            y=unique(df_complet$calculation),x="Modalité")
```
