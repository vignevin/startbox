...
Il est possible d'utiliser la fonction `standardise_topvigne_csv` qui permet de vérifier si le fichier provient bien de TopVigne, de le transformer et standardiser les données collectées avec Topvigne.
